	...
	while True:
		try:
			...
			if X2 is None:
				...
				continue
			# print("X2 gives: ", X2.shape)
			# print("Y1 gives: ", Y1.shape)
			# print("Y2 gives: ", Y2.shape)
			# pdb.set_trace()
			...
			if iter_num == epoch_length:
				...
				model_all.save_weights(os.path.join(C.model_save_dir, 'model_{}.hdf5'.format(epoch_num)))
